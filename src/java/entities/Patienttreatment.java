...
public class Patienttreatment  implements java.io.Serializable {
    ...
    public Patienttreatment(String patientid, String code, int treatmentid, String dosage, int visitationid, Date date, double price, String dispensed, double amounpaid) {
    ...
    public Patienttreatment(String patientid, String code, int treatmentid, String dosage, int visitationid, Date date, double price, Integer quantity, String type, String note, String dispensed, double amounpaid) {
       this.patientid = patientid;
       this.code = code;
       this.treatmentid = treatmentid;
       this.dosage = dosage;
