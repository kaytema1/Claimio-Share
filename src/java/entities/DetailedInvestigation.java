...
/**
 * DetailedInvestigation generated by hbm2java
 */
public class DetailedInvestigation  implements java.io.Serializable {
    ...
    public DetailedInvestigation() {
    }

	
    public DetailedInvestigation(String code, String name, int labTypeId, int typeOfTestId, boolean resultOptions) {
        this.code = code;
        this.name = name;
    ...
    public DetailedInvestigation(String code, String name, Double rate, String lowBound, String highBound, int labTypeId, int typeOfTestId, Integer groupedUnderId, String units, String interpretation, String defaultValue, String rangeFrom, String rangeUpTo, String comments, String reportCollDays, Date reportCollTime, boolean resultOptions) {
       this.code = code;
       this.name = name;
       this.rate = rate;
