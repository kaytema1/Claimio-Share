                ...
                <div class="row">
                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    ...
                                    <a> <i class="icon-tasks"></i>Complete The Fields Below To Add A New Unit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="dialog_link">
                                        ...
                                        <i class="icon-tasks"></i>Show Departments
                                    </a>
                            ...
                            <form action="action/departmentaction.jsp" method="post" onsubmit="return validateForm();" name="items" >
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='submitform();return false;'>
                                            <i class="icon-arrow-right icon-white"> </i> Add Department 
                                        </button>
                    ...
                    <table class="example display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-group btn-medium" id="<%=unit.getDepartmentid()%>_link">
                                        <i class="icon-arrow-right icon-white"> </i> Edit 
                                    </button>
                                    <div style="display: none;" id="<%=unit.getDepartmentid()%>_dialog" title="Editting <%=unit.getDepartment()%>">
                                        <form action="action/unitaction.jsp" method="post" onsubmit="return validateForm();" name="edit">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='updateUnit("nameunit_<%=unit.getDepartmentid()%>","unitid_<%=unit.getDepartmentid()%>");return false;'>
                                                    <i class="icon-arrow-right icon-white"> </i> Update Department 
                                                </button>
                                ...
                                <td>
                                    <form action="action/unitaction.jsp" method="post">
                                        ...
                                        <button class="btn btn-danger btn-medium" type="submit" name="action" value="units" onclick='deleteUnit("id_<%=unit.getDepartmentid()%>");return false;'>
