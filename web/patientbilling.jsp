			...
			$(function() {
				...
				$(document).ready(function() {
					chart = new Highcharts.Chart({
						...
						tooltip : {
							formatter : function() {
								return Highcharts.numberFormat(this.y, 0) + ' Cedis in ' + this.x;
							}
						},

						series : [{
							name : 'All Patients',
							data : [20, 50, 100, 240, 300, 400, 702]
						}, {
							name : 'Inpatients',
							data : [15, 20, 30, 100, 200, 100, 426]
						},
						 {
							name : 'Outpatients',
							data : [5, 30, 70, 140, 100, 300, 426]
						}]
					});
					...
					chart2 = new Highcharts.Chart({
						...
						title : {
							text : 'Total Value of Claims Submitted ',
					...
					chart3 = new Highcharts.Chart({
						...
						title : {
							text : 'Total Value of Claims Paid',
				...
				<div class="row">
					...
					<div style="margin-top: 0px; "class="span12 offset3 content1 hide">
						<ul class="breadcrumb span9 pull-right" style="padding-bottom: 0px; line-height: 27px;">
							<li>
								<h4><a href="#"> Patient Billing</a></h4>
							</li>
