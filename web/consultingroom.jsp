                        ...
                        <table class="table"> 
                            <tr>
                                <td>
                                    ...
                                    <select class="input-xxlarge" id="diagnosis<%=visit.getVisitid()%>" onchange =''>
                    ...
                    <div style="display: none;" class="well thumbnail center laboratory">
                        ...
                        <script>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <select class="input-xxlarge"  id="test<%=visit.getVisitid()%>" onchange = ''>
                                            <option value="Select">Select Investigation</option>
                                            <%
                                                // List treatments = mgr.patientTreatment(int visitationid);
                    ...
                    <div style="display: none;" class="well thumbnail center clerk">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table">
                            ...
                            <thead>
                                <tr>
                                    <th>
                                        <label style="color: white; font-weight: bolder"> Question </label>
                                    </th>
                                    <th>
