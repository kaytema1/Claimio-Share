    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
        ...
        <div class="container-fluid">
            ...
            <section style="margin-top: -30px;" id="dashboard">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    ...
                                    <br/>
                                    <a> <i class="icon-tasks"></i>Complete The Fields Below To Add A New Permission</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="dialog_link">

                                        <i class="icon-tasks"></i>Show Permission
                                    </a>
                            ...
                            <form action="" method="post" name="items" >
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button class="btn btn-danger btn-large" type="submit" onclick='submitform();return false;'>
                                            <i class="icon-arrow-right icon-white"> </i> Add Permission 
                                        </button>
                ...
                <div style="display: none;" id="dialog" title="List of All Permissions">
                    <table class="example display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-group btn-medium" id="<%=unit.getPermissionid()%>_link">
                                        <i class="icon-arrow-right icon-white"> </i> Edit 
                                    </button>
                                    <div style="display: none;" id="<%=unit.getPermissionid()%>_dialog" title="Editting <%=unit.getPermission()%>">
                                        <form action="action/unitaction.jsp" method="post" onsubmit="return validateForm();" name="edit">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='updateUnit("nameunit_<%=unit.getPermissionid()%>","unitid_<%=unit.getPermissionid()%>");return false;'>
                                                    <i class="icon-arrow-right icon-white"> </i> Update Permission 
                                                </button>
                                ...
                                <td>
                                    <form action="" method="post">
                                        ...
                                        <button class="btn btn-danger btn-medium" type="submit" name="action" value="units" onclick='deleteUnit("id_<%=unit.getPermissionid()%>");return false;'>
