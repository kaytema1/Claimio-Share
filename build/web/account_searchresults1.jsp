                                    ...
                                    <td>
                                        <div style="display: block" id="s_<%=p.getPatientid()%>">
                                            <select name="contype" onchange='showConType("d_<%=p.getPatientid()%>")' id="ty">
                                                ...
                                                <option value="">Billing History</option> 
                                            </select>
                                        </div>
                                        <div id="d_<%=p.getPatientid()%>" style="display: none">
                                            <a  id="patientidlink"  class="btn btn-info" onclick='getContype()'> <i class="icon-pencil icon-white"> </i> View Billing </a>
                                        </div></td>
                                </tr>
        ...
        <div style="max-height: 600px; y-overflow: scroll; display: none;" class="usersummary hide" id="<%= p.getPatientid()%>"  title="Patient Information">
            <div class="well thumbnail">
                ...
                <%
                    ...
                    int visitId = 0;
                    List pList = mgr.listPatientVisits(patientId);
                    Visitationtable vTable = null;
                    
                    for(int i = 0; i < pList.size(); i++) {
                        vTable = (Visitationtable)pList.get(i);
                        visitId = vTable.getVisitid();
                        System.out.println("lkajf : " + visitId);
                    }
                    
                    System.out.println("new : " + visitId);
                %>
...
mgr.getPatientConsultationByVisitid(visitId);
//System.out.println("pCon " + pCon.size());
%>
