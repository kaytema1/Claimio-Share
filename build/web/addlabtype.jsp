                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    <h4>Add New Lab Type</h4>
                                    <br/>
                                    <a> <i class="icon-tasks"></i>Complete The Fields Below To Add A New Lab Type</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <form action="action/labtypeaction.jsp" method="post" onsubmit="return validateForm();" name="items" >

                                <fieldset>
                                     <label>Code : </label><input type="text" name="code" value=""/><br/>
                                    <div class="control-group">
                                        <label class="control-label" for="input01"> Lab Type Name: </label>
                                        <div class="controls">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='submitform();return false;'>
                                            <i class="icon-arrow-right icon-white"> </i> Add Lab Type 
                                        </button>
