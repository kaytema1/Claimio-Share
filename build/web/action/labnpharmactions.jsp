            ...
            if (!patientid.equalsIgnoreCase("") || id != 0) {
                ...
                if (labtest != null) {
                    ...
                    for (int i = 0; i < labtest.length; i++) {
                        ...
                        mgr.addPatientInvestigation(patientid, "CODE", Integer.parseInt(investigationcode[1]), "", mgr.getInvestigation(Integer.parseInt(investigationcode[1])).getRate(), id, formatter.format(date), "No", investigationnote, 0);
