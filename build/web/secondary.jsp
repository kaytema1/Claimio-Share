                    ...
                    <div style="display: block; " class="well thumbnail center vital">
                        ...
                        <table class="table span3 right table table-bordered table-condensed">
                            <tr>
                                ...
                                <td><b><%=vts[0] == null ? "" : vts[0]%> (Celsius)</b></td>
                            </tr>

                            <tr>
                                <td>Weight </td>

                                <td><b><%=vts[1] == null ? "" : vts[1]%> (Kg)</b></td>
                            </tr>

                            <tr>
                                <td>Height </td>

                                <td><b><%=vts[2] == null ? "" : vts[2]%> (m)</b></td>
                            </tr>
                            <tr>
                                <td>Blood Pressure </td>

                                <td><b>Systolic <%=bps[0] == null ? "" : bps[0]%></b><br/>
                                    <b>Diatolic <%=bps[1] == null ? "" : bps[1]%></b><br/>
                                    <b>Pulse <%=vts[4] == null ? "" : vts[4]%> (minutes)</b><br/>
                                </td>
                            </tr>
                            <tr>
                                <td>Symptoms </td>

                                <td><b><%=vts[5] == null ? "" : vts[5]%></b></td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <% for (int s = 0; s < pInvestigation.size(); s++) {
                                                ...
                                                if (pi != null) {
                                        %>
                                        <h5><%= mgr.getInvestigation(pi.getInvestigationid()).getName()%></h5> 
                                        <% }
                                            }%>
                                    </td>
                                    <td>
